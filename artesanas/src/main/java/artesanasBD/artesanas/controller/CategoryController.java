...
import artesanasBD.artesanas.service.CategoryService;
...
@CrossOrigin(origins = "*", methods = { RequestMethod.GET, RequestMethod.POST, RequestMethod.DELETE,
    RequestMethod.PUT })
@Tag(name = "Categories", description = "provides methods categories ")
public class CategoryController {
    ...
    public List<Category> getCustomersByName(@PathVariable String name) {
